...
w = Label(root, text='Chocs And Ice Creams', font="50")
w.pack()
...
b3_button = Button(frame, text="Dark Choco", fg="brown", bg="beige")
...
b6_button = Button (bottomframe, text="Ice Cream", fg="green", bg="cyan")
